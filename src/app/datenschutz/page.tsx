    ...
    <div className="section">
      <div className="container prose max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4">1. Verantwortlichkeit</h2>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              E-Mail: <a href="mailto:info@a4plus.eu" className="text-blue-600 hover:underline">info@a4plus.eu</a><br/>
              Telefon: +49 (0) 6233 37988-0
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-semibold mb-4">2. Begriffsbestimmung</h2>
            <p className="mb-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4">3. Bereitstellung der Website und Server-Logfiles</h2>
            <h3 className="text-xl font-medium mb-3">3.1 Umfang der Verarbeitung</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3">3.2 Zweck der Verarbeitung</h3>
            <p className="mb-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4">4. Einsatz von Cookies</h2>
            <h3 className="text-xl font-medium mb-3">4.1 Allgemeine Informationen</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3">4.2 Essenzielle Cookies</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3">4.3 Nicht essenzielle Cookies</h3>
            <p className="mb-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4">5. PV-Rechner und Kontaktformulare</h2>
            <h3 className="text-xl font-medium mb-3">5.1 Umfang der Verarbeitung</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3">5.2 Zweck der Verarbeitung</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3">5.3 Rechtsgrundlage</h3>
            <p className="mb-4">
              Die Rechtsgrundlage ist Art. 6 Abs. 1 lit. b) DSGVO, da die Berechnung im Zuge der Anbahnung eines Vertrags geschieht.
            </p>

            <h3 className="text-xl font-medium mb-3">5.4 Speicherdauer</h3>
            <p className="mb-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4">6. Empfänger personenbezogener Daten</h2>
            <p className="mb-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4">7. Datenübermittlung in Drittländer</h2>
            <p className="mb-4">
          ...
          <div>
            ...
            <p className="mb-4">
              ...
              <a href="mailto:info@a4plus.eu" className="text-blue-600 hover:underline">info@a4plus.eu</a>
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-semibold mb-4">10. Beschwerde bei einer Aufsichtsbehörde</h2>
            <p className="mb-4">
          ...
          <div className="text-sm text-gray-500 mt-8 pt-4 border-t">
            ...
            <p className="mt-2">
              ...
              <a href="mailto:info@a4plus.eu" className="text-blue-600 hover:underline ml-1">info@a4plus.eu</a>
            </p>
          </div>
        </div>
      </div>
